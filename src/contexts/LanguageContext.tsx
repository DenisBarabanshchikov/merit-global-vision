...
const translations = {
  en: {
    ...
    'history.milestone.19': 'Won the MODON Award for industrial innovation for the second consecutive year.',
  ...
  ar: {
    ...
    // Vision & Mission
    'vision.title': 'رؤيتنا',
    'vision.text': 'نحن في ميريت نؤمن بالتنوع والتميز والاستمرارية. نسعى لأن نكون شريكاً عالمياً للمنتجات والخدمات المتطورة.',
    'mission.title': 'رسالتنا',
    'mission.text': 'لتحقيق الرؤية، نركز على الشراكات الاستراتيجية، والتعاون مع المحترفين في مجالاتهم، وخلق أقصى قيمة لجميع أصحاب المصلحة.',
    ...
    'history.milestone.19': 'الفوز بجائزة مدن للابتكار الصناعي للعام الثاني على التوالي.',
  ...
  ru: {
    ...
    'history.milestone.19': 'Получение премии MODON за инновации в промышленности второй год подряд.',
